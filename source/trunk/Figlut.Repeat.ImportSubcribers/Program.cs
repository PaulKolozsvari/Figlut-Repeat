namespace Figlut.Repeat.ImportSubcribers
{
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            try
            {
                string webServiceBaseUrl = "http://127.0.0.1:2983/FiglutRepeat";
                //string webServiceBaseUrl = "http://127.0.0.1:2983/FiglutRepeat";
                ...
                List<string> cellPhoneNumbers = ReadCellPhoneNumbers(@"C:\Docs\Work\FiglutRepeatRepo\customers\Motion Footwear\Randburg Custmer list.csv");
