namespace Figlut.Repeat.Receiver.Web.Service.Configuration
{
    ...
    public class RepeatReceiverSettings : Settings
    {
        #region Constructors

        public RepeatReceiverSettings()
            : base()
        {
        }

        public RepeatReceiverSettings(string name)
            : base(name)
        {
        }

        public RepeatReceiverSettings(string name, string filePath)
            : base(name, filePath)
        {
        }
