namespace Figlut.Repeat.Receiver.Web.Service.REST
{
    ...
    public class RepeatReceiverRestService : RestService, IRepeatReceiverRestService
    {
        #region Methods
        ...
        {
            if (RepeatReceiverApp.Instance.Settings.AuditServiceCalls)
            {
        ...
        public Stream Login()
        {
            ...
            catch (Exception ex)
            {
                ...
                RepeatReceiverApp.Instance.EmailSender.SendExceptionEmailNotification(ex);
            ...
            string checksumValue)
        {
            try
            {
                ...
                SmsReceivedQueueItem queueItem = RepeatReceiverApp.Instance.EnqueueSmsReceived(
                    fromValue,
                    messageIdValue,
                    messageValue,
                    dateValue,
            ...
            string checksumValue)
        {
            try
            {
                ...
                m.AppendLine(string.Format("checksum: {0}", checksumValue));
                AuditServiceCall(m.ToString());
                SmsDeliveryReportLog smsDeliveryReportLog = RepeatReceiverApp.Instance.LogSmsDeliveryReportToDB(
                    fromValue,
                    messageIdValue,
                    messageValue,
                    dateValue,
