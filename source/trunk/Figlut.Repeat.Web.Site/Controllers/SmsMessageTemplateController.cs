namespace Figlut.Repeat.Web.Site.Controllers
{
    ...
    public class SmsMessageTemplateController : RepeatController
    {
        #region Constants
        ...
        private void RefreshOrganizationsList(RepeatEntityContext context, Organization defaultOrganization)
        {
            if (context == null)
            {
                context = RepeatEntityContext.Create();
