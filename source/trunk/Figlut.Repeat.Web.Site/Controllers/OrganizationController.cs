namespace Figlut.Repeat.Web.Site.Controllers
{
    ...
    public class OrganizationController : RepeatController
    {
        #region Constants
        ...
        private FilterModel<OrganizationModel> GetOrganizationFilterModel(RepeatEntityContext context, FilterModel<OrganizationModel> model)
        {
            if (context == null)
            {
                context = RepeatEntityContext.Create();
            }
            string currencySymbol = RepeatWebApp.Instance.GlobalSettings[GlobalSettingName.DefaultCurrencySymbol].SettingValue;
        ...
        private void RefreshAccountManagersList(RepeatEntityContext context, User defaultUser)
        {
            if (context == null)
            {
                context = RepeatEntityContext.Create();
