function createLoginDialog(dialogName, title, onOKCallBack, onOpenDialog, onCancelCallBack, onResetPasswordCallBack, dialogHeight, dialogWidth) {
    var buttons = undefined;
    if (onOKCallBack != undefined && onCancelCallBack != undefined && onResetPasswordCallBack != undefined) {
        buttons = [
            {
                text: "OK",
