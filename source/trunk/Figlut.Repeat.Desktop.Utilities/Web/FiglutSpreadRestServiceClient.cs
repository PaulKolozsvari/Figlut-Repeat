namespace Figlut.Repeat.Desktop.Utilities.Web
{
    ...
    public class FiglutRepeatRestServiceClient : RestWebServiceClient
    {
        #region Constructors

        public FiglutRepeatRestServiceClient(IMimeWebServiceClient webServiceClient, int timeout)
