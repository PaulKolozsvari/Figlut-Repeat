namespace Figlut.Spread.Receiver.Web.Service.Configuration
{
    ...
    public class SpreadReceiverSettings : Settings
    {
        #region Constructors

        public SpreadReceiverSettings()
            : base()
        {
        }

        public SpreadReceiverSettings(string name)
            : base(name)
        {
        }

        public SpreadReceiverSettings(string name, string filePath)
            : base(name, filePath)
        {
        }
