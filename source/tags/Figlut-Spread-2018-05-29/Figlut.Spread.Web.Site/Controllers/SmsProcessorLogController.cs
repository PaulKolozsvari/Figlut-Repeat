namespace Figlut.Spread.Web.Site.Controllers
{
    ...
    public class SmsProcessorLogController : SpreadController
    {
        #region Constants
            ...
            Nullable<Guid> smsProcessorId)
        {
            ...
            bool smsProcessorMessageTrimOnGrid = Convert.ToBoolean(SpreadWebApp.Instance.GlobalSettings[GlobalSettingName.SmsProcessorMessageTrimOnGrid].SettingValue);
            int smsProcessorMessageTrimLengthOnGrid = Convert.ToInt32(SpreadWebApp.Instance.GlobalSettings[GlobalSettingName.SmsProcessorMessageTrimLengthOnGrid].SettingValue);
