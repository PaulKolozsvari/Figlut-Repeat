namespace Figlut.Spread.Web.Site.Controllers
{
    ...
    public class SmsReceivedController : SpreadController
    {
        #region Constants
        ...
        private FilterModel<SmsReceivedLogModel> GetSmsReceivedFilterModel(SpreadEntityContext context, FilterModel<SmsReceivedLogModel> model)
        {
            if (context == null)
            {
